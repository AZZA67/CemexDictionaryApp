    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_customer_Questions", x => x.ID);
                    table.ForeignKey(
                        name: "FK_customer_Questions_AspNetUsers_AdminId",
                        column: x => x.AdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_customer_Questions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerQuestionMedias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerQuestionMedias_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_customer_Questions_AdminId",
                table: "customer_Questions",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_customer_Questions_CategoryId",
                table: "customer_Questions",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_customer_Questions_UserId",
                table: "customer_Questions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerQuestionMedias_QuestionId",
                table: "CustomerQuestionMedias",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerQuestionMedias_UserId",
                table: "CustomerQuestionMedias",
                column: "UserId");
